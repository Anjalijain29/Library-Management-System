...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/except.css"/>
</head>
<body>
...
<div class="container">
	<div class="left-section">
		<div class="inner-content">
			...
			<p class="subheading">
			 Kindly proceed to <a href="${pageContext.request.contextPath}" style="color:#eee">Home</a>
			</p>
		</div>
	</div>
