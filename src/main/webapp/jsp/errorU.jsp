...
<head>
  ...
  <link href="${pageContext.request.contextPath}/css/notAuthorizedUser.css" rel="stylesheet" >
...
<h1>403</h1>
<h2>Kindly login to access this facility</h2>
<a href = "${pageContext.request.contextPath}/login" ><h2>Click here to login</h2></a>
</body>
</html>
