...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/issuerequest.css">
<link rel="stylesheet"
...
<div class="content">
	<div class="mid justify-content-center">
		<div class="text-primary lbl">Issue Requests</div>
		<div class="sort">
			<h4>Sort By</h4>
			<form>
						...
						<div class="modal-dialog ">
							<div class="modal-content">
								<div class="modal-header header">
									<h5 class="modal-title " id="exampleModalLabel">Request ID
										: ${list.getRequestId()}</h5>
								...
								<div class="modal-body">
									<h5>
										<b>Member ID : </b>
										<p>${list.getMember().getUser().getUserId()}</p>
									</h5>
									<h5>
										<b>Member Name : </b>
										<p>${list.getMember().getUser().getFirstName()}
											${list.getMember().getUser().getLastName()}</p>
									</h5>
									<h5>
										<b>Book ID : </b>
										<p>${list.getBook().getBookId()}</p>
									</h5>
									<h5>
										<b>Book Title : </b>
										<p>${list.getBook().getTitle()}</p>
									</h5>
									<h5>
										<b>Request Date : </b>
										<p>${list.getRequestDate()}</p>
									</h5>
									<h5>
										<b>Member Status : </b>
										<p>${list.getMember().getUser().getStatus()}</p>
									</h5>
									<h5>
										<b>Member Warnings : </b>
										<p>${list.getMember().getUser().getWarnings()}</p>
									</h5>
								...
								<div class="modal-footer justify-content-center">
									...
									<button type="button"
										class="btn btn-outline-success waves-effect mx-3">Accept</button>
									<button type="button"
										class="btn btn-outline-danger waves-effect mx-3">Reject</button>
								</div>
							</div>
